...
export class ProfileController {
    ...
    async getUsersCountsFollowing(
        @Param() { user_uid }: GetProfileUserDto,
    ) {
    ...
    async getFollowingUsers(
        ...
        dto.uid = current_uid
        const data = await this.profileService.getFollowingUsers({...dto, ...dtoQuery})
    ...
    async getFollowingPets(
        ...
        dto.uid = current_uid
        const data = await this.profileService.getFollowingPets({...dto, ...dtoQuery})
